...
// Step 2: As Player transfer Tokens to Attacker Contract
...
//Step 3: Attacker Transfer Tokens to Bank Contract
// Token Contract Balance:
// Deployer: 500K
// TokenBank: 500k
// Attacker : 0
...
//Step 4: Withdraw as Attacker Contract



// Step 3: As Attacker Contract Transfer Tokens to Challenge Contract
// -> This will trigger balanceOf Mapping for Attacker contract to increase in value
// Step 4: As Attacker Contract, withdraw
// Step 5: This will cause Bank contract to transfer to Attacker Contract 500k
// Step 6: Enter tokenFallbackHook
// Step 7: Call withdraw again